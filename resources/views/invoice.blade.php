                        ...
                        <div class="bg-white rounded-lg">
                            <div class="ml-3 pt-3 pb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="row col-md-7">
                                        <div class="col-md-7">
                                            <input id="issuing_date" type="text" class="form-control @error('issuing_date') is-invalid @enderror" name="issuing_date" value="{{ old('issuing_date') }}" placeholder="Select date" autocomplete="" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="row col-md-7">
                                        ...
                                        <div class="col-md-5 d-flex align-self-center">
                                            <div id="selectedCurrency" class="ml-1">$</div>
                                            <div id="priceWithVAT" class="ml-1">0,00</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
